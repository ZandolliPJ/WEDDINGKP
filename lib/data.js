...
export const WEDDING = {
  ...
  marie: 'Pascal',
  date: '30 Juin 2026',
  dateISO: '2026-06-30T14:00:00',
  rsvpLimit: '01 Mai 2026',

  ceremonieCivile: {
    heure: '14h00',
    lieu: 'La Ferme Neuve',
    adresse: '1 rue Henri Rol-Tanguy, 91350 GRIGNY',
    maps: 'https://maps.google.com/?q=1+rue+Henri+Rol-Tanguy+91350+Grigny',
  },
  ceremonieLaique: {
    heure: '17h30',
    lieu: 'Salle Jasmine',
...
export const TIMELINE = [
  { heure: '14h00', icon: '⚖️', titre: 'Cérémonie Civile', lieu: 'La Ferme Neuve', desc: '1 rue Henri Rol-Tanguy, 91350 GRIGNY', color: '#c9a84c' },
