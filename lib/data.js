...
export const WEDDING = {
  ...
  ceremonieCivile: {
    heure: '14h00',
    lieu: 'Ferme Neuve',
    adresse: '1 rue Henri Rol-Tanguy, Face du collège Sonia Delaunay, 91000 Grigny',
    maps: 'https://maps.google.com/?q=1+rue+Henri+Rol-Tanguy+91000+Grigny',
  },
  ceremonieLaique: {
    heure: '17h30',
    lieu: 'Salle Jasmine',
...
export const TIMELINE = [
  { heure: '14h00', icon: '⚖️', titre: 'Cérémonie Civile', lieu: 'Ferme Neuve', desc: '1 rue Henri Rol-Tanguy, Face du collège Sonia Delaunay, 91000 Grigny', color: '#c9a84c' },
  { heure: '17h30', icon: '💍', titre: 'Cérémonie Laïque', lieu: 'Salle Jasmine', desc: 'Échange des vœurs & des alliances', color: '#e91e8c' },
  { heure: '19h00', icon: '🥂', titre: "Vin d'Honneur", lieu: 'Salle Jasmine', desc: '8 rue des Gaillards, 95140 Garges-lès-Gonesse', color: '#4caf7d' },
  { heure: '19h30', icon: '🍽️', titre: 'Dîner de Gala', lieu: 'Salle Jasmine', desc: 'Menu Balade Tropicale', color: '#f39c12' },
  { heure: '21h00', icon: '🎶', titre: 'Soirée Dansante', lieu: 'Salle Jasmine', desc: "La nuit n'est que le début…", color: '#9b59b6' },
]
