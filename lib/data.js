...
export const TIMELINE = [
  { heure: '14h00', icon: '⚖️', titre: 'Eclosion des promesses', lieu: 'Mairie de Grigny', desc: '19 Rte de Corbeil, 91350 Grigny', color: '#c9a84c' },
  { heure: '17h30', icon: '💍', titre: 'Bénédiction nuptiale', lieu: 'Salle Jasmine', desc: 'Échange des vœurs & des alliances', color: '#e91e8c' },
  { heure: '19h00', icon: '🥂', titre: "Salutation des mariés", lieu: 'Salle Jasmine', desc: '8 rue des Gaillards, 95140 Garges-lès-Gonesse', color: '#4caf7d' },
  { heure: '19h30', icon: '🍽️', titre: 'Dîner', lieu: 'Salle Jasmine', desc: 'Menu Balade Tropicale', color: '#f39c12' },
  { heure: '21h00', icon: '🎶', titre: 'Envolée du bal', lieu: 'Salle Jasmine', desc: "La nuit n'est que le début…", color: '#9b59b6' },
]
