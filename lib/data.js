...
export const WEDDING = {
  ...
  ceremonieCivile: {
    heure:   '11h30',
    lieu:    'Mairie de Créteil',
    adresse: '1 rue Tirard, 94000 Créteil',
    maps:    'https://maps.google.com/?q=1+rue+Tirard+Creteil',
  },
  vinHonneur: {
    heure:   '13h00',
    lieu:    'Salle Jasmine',
...
export const TIMELINE = [
  { heure: '11h30', icon: '⚖️',  titre: 'Cérémonie Civile',  lieu: 'Mairie de Créteil',  desc: '1 rue Tirard, 94000 Créteil',                         color: '#c9a84c' },
...
export const TABLES = [
  { id: 1,  name: 'Hibiscus',           flower: '🌺', capacity: 10, theme: 'Hibiscus rouge des Antilles'     },
  { id: 2,  name: 'Frangipanier',       flower: '🌸', capacity: 10, theme: 'Frangipanier rose et blanc'      },
  { id: 3,  name: 'Balisier',           flower: '🌷', capacity: 10, theme: 'Balisier rouge national'         },
  { id: 4,  name: 'Bouganvillée',       flower: '💜', capacity: 10, theme: 'Bouganvillée violette'           },
  { id: 5,  name: 'Lantana',            flower: '🌼', capacity: 10, theme: 'Lantana jaune-orange'            },
  { id: 6,  name: 'Alamanda',           flower: '🌻', capacity: 10, theme: 'Alamanda dorée'                  },
  { id: 7,  name: 'Anthurium',          flower: '❤️', capacity: 10, theme: 'Anthurium rouge flamme'          },
  { id: 8,  name: 'Heliconias',         flower: '🦜', capacity: 10, theme: 'Heliconia exotique'              },
  { id: 9,  name: 'Oiseau du Paradis',  flower: '🐦', capacity: 10, theme: 'Strelitzia — Oiseau du Paradis'  },
  { id: 10, name: 'Cactus',             flower: '🌵', capacity: 10, theme: 'Cactus fleuri'                   },
  { id: 11, name: "Cœur d'Amour",       flower: '💛', capacity: 10, theme: 'Table des mariés'                },
